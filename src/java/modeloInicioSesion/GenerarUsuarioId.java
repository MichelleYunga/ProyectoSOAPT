...
public class GenerarUsuarioId {
    ...
    public Cliente generarClienteConID(String nombre, String apellido, String cedula, String username, String password, String password1, String pregunta, String respuesta) {
        int nuevoID = idautoincremental;
        idautoincremental++;

        Cliente cli = new Cliente(nuevoID, nombre, apellido, cedula, username, password, password1, pregunta, respuesta);
        clientes.add(cli);
        return cli;
    }
