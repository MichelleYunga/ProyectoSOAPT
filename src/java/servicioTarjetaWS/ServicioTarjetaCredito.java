...
public class ServicioTarjetaCredito {
    ...
    public String RegistroTarjeta(@WebParam(name = "numero") String numero,
            ...
            @WebParam(name = "cliente") String cedulaCliente) {

        try {
            
            Cliente propietario = dataRepository.getClientByCedula(cedulaCliente);
            System.out.println("User: " + propietario.getNombre() + " " + propietario.getApellido());
            
            if (propietario == null) {
                System.out.println("No se encontró el cliente con la cédula: " + cedulaCliente);
            ...
            for (TarjetaCredito tarjeta : tarjetasCredito) {
                if (numero.equals(tarjeta.getNumero())) {
                    ...
                    return "TARJETA DE CRÉDITO YA REGISTRADA";
                }
            }
